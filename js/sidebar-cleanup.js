/* Keep the premium side drawer focused: remove items already represented on the homepage. */
(function(){
  ...
  function clean(){
    ...
    if(links)links.querySelectorAll('a').forEach((a,i)=>{
      const num=a.querySelector('em');
