...
form.addEventListener("submit",async(e)=>{
 ...
 const row={
  name:f.get("name"), education:f.get("education"), job:f.get("job"),
  city:f.get("city"), state:f.get("state"), country:f.get("country"),
  blood_group:f.get("blood_group"), skills:f.get("skills"), phone:f.get("phone"),
  is_public:f.get("is_public")==="on", blood_public:f.get("blood_public")==="on",
  status:"pending"
 };
