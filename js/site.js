...
(function(){
  ...
  document.addEventListener('DOMContentLoaded',function(){
    ...
    const oldQuick=document.querySelector('.side-categories');if(oldQuick)oldQuick.remove();
