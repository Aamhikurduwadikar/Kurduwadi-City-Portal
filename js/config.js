...
window.KURDUWADI_CONFIG={SUPABASE_URL:'https://rjfgfdgrqficffbyqvlf.supabase.co',SUPABASE_ANON_KEY:'sb_publishable_G3lGu7INXtIGmjum8nj7_A_opGtO3B2',STORAGE_BUCKET:'community-images',GA_MEASUREMENT_ID:'G-XXXXXXXXXX',SITE_NAME:'Kurduwadi City Portal',SITE_URL:'https://kurduwadi-city-portal.vercel.app/'};
(function(){
  ...
  if(profile){css('kpProfileMobile','css/profile-mobile.css');js('js/portal-ui-fixes.js')}
  if(reps){js('js/representatives-instagram.js');js('js/portal-ui-fixes.js')}
  if(admin)js('js/work-fields-admin.js');
